...
const ServiceTicketHistorySchema = new Schema<IServiceTicketHistory>({
  ...
  time: {
    type: String,
    default: null,
    match: /^(0[1-9]|1[0-2]):[0-5][0-9]\s?(AM|PM|am|pm)$/,
  },
...
const ServiceTicketHistory: Model<IServiceTicketHistory> =
  mongoose.model<IServiceTicketHistory>(
    "ServiceTicketHistory",
    ServiceTicketHistorySchema
  );
